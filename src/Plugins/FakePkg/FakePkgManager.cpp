...
bool FakePkgManager::ShellCorePatch()
{
    ...
    uint8_t xor__ebx_eax[5] = { 0x31, 0xC0, 0xFF, 0xC0, 0x90 };
    uint8_t xor__ecx_eax[1] = { 0x00 };
    uint8_t xor__edx_eax[4] = { 0x48, 0x31, 0xC0, 0xC3 };
    uint8_t xor__eex_eax[3] = { 0x31, 0xC0, 0xC3 };
    ...
    s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchA),  3,    (void*)"\xC9\xA9\x96", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchA");
		   return false;
	  }
    s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchB),  3,    (void*)"\xC0\x71\x96", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchB");
		   return false;
	  }
    s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchC),  3,    (void*)"\xC0\x71\x96", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchC");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchD),  3,    (void*)"\xC0\x71\x96", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchD");
		   return false;
	  }
    s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchE),  3,    (void*)"\xC0\x71\x96", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchE");
		   return false;
	  }
    s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchF),  3,    (void*)"\xC0\x71\x96", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchF");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchG),  3,    (void*)"\x50\x79\x97", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchG");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchH),  3,    (void*)"\x50\x79\x97", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchH");
		   return false;
	  }	  
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchI),  3,    (void*)"\x50\x79\x97", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchI");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchJ),  3,    (void*)"\x80\xBB\x97", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchJ");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchK),  3,    (void*)"\x80\xBB\x97", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchK");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchL),  3,    (void*)"\x40\x39\x97", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchL");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchM),  3,    (void*)"\x40\x39\x97", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchM");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchN),  2,    (void*)"\x48\xB9", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchN");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchO),  3,    (void*)"\x00\x00\x00", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchO");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchP),  8,    (void*)"\x55\x48\x89\xE5\xE8\xF7\xE8\xB1", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchP");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchQ),  8,    (void*)"\x55\x48\x89\xE5\x41\x56\x53\x48", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchQ");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchR),  6,    (void*)"\x48\x8B\x47\x68\x48\xC1", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchR");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchS),  6,    (void*)"\xF6\x47\x17\x04\x74\x0B", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchS");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchT),  50,    (void*)"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchT");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchU),  594,    (void*)"", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchU");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchV),  235,    (void*)"", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchV");
		   return false;
	  }
	 	s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchW),  484,    (void*)"", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchW");
		   return false;
	  } 
    s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchX),  9,    (void*)"\x00\x00\x00\x00\x00\x00\x00\x00\x00", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchX");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,     (void*)(s_TextStart + ssc_enable_testkit_patchY),  105,    (void*)"", nullptr, true);
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchY");
		   return false;
	  }
    s_Ret = Utilities::ProcessReadWriteMemory(s_Process,    (void*)(s_TextStart + ssc_enable_testkit_patchZ),  265,    (void*)"", nullptr, true);            
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patchZ");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,    (void*)(s_TextStart + ssc_enable_testkit_patch1A),  4,    (void*)"\xFF\xFF\xFF\xFF", nullptr, true);           
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patch1A");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,    (void*)(s_TextStart + ssc_enable_testkit_patch1B),  2,    (void*)"\x48\x3B", nullptr, true);           
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patch1B");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,    (void*)(s_TextStart + ssc_enable_testkit_patch1C),  4,    (void*)"\xE0\x00\x00\x00", nullptr, true);           
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patch1C");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,    (void*)(s_TextStart + ssc_enable_testkit_patch1D),  4,    (void*)"\xE8\x39\xB1\x2A", nullptr, true);           
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patch1D");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,    (void*)(s_TextStart + ssc_enable_testkit_patch1E),  14,    (void*)"\x55\x48\x89\xE5\x41\x57\x41\x56\x41\x55\x41\x54\x53\x48", nullptr, true);           
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patch1E");
		   return false;
	  }
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process,    (void*)(s_TextStart + ssc_enable_testkit_patch1F),  5,    (void*)"\xE8\x6F\x85\x2A\x00", nullptr, true);           
	  if (s_Ret < 0)
	    {
		   WriteLog(LL_Error,     "ssc_enable_testkit_patch1F");
		   return false;
	  } 
