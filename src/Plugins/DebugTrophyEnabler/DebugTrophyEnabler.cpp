...
#include "DebugTrophyEnabler.hpp"
...
DebugTrophyEnabler::DebugTrophyEnabler()
{
...
bool DebugTrophyEnabler::OnLoad()
{
	...
	s_Ret = Utilities::ProcessReadWriteMemory(s_Process, (void*)(s_TextStart + ssc_sceKernelIsGenuineCEX_patchE), 5, (void*)"\x31\xC0\x90\x90\x90", nullptr, true);
	if (s_Ret < 0)
	{
...
bool DebugTrophyEnabler::OnUnload()
{
	return true;
}

bool DebugTrophyEnabler::OnSuspend()
{
	return true;
}

bool DebugTrophyEnabler::OnResume()
{
	return true;
}
