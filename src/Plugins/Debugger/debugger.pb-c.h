...
struct  _DbgBreakpointRequest
{
  ...
  protobuf_c_boolean has_address;
  uint64_t address;
  protobuf_c_boolean has_original;
  uint32_t original;
  protobuf_c_boolean has_breakpointtype;
...
{
  ProtobufCMessage base;
  protobuf_c_boolean has_breakpointhandle;
...
{
  ProtobufCMessage base;
  protobuf_c_boolean has_watchpointhandle;
...
struct  _DbgGetKernelInfoResponse
{
   ...
   * len 140?
   */
  protobuf_c_boolean has_gloablconfigdata;
